...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public Cursor getBookings(){
        //Gets all the data from localdatabase
    ...
    public void insertBookings(int booking_id, int room_id, int guest_ref,
        ...
        //These are the values we want to insert into the LOCAL database, hence
        // titled booking_history.
    ...
    //Check if online booking data exists in local db
    //Accepts the online db data
        public void checkDuplicate(ArrayList<Booking_History> bookings){
            SQLiteDatabase db= getReadableDatabase();
            ...
            for(int i=0;i<duplicates.size();i++){
                //Replace with code to return non-duplicate data, TODO
